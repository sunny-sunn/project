  ...
  <div class="panel">
    ...
    <div class="heading">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item><a href="#/app/product">分类管理</a></el-breadcrumb-item>
    ...
    <div class="list">
      <el-table ref="table" :data="searchData" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="发布日期" prop="addtime" :formatter="formatTime" width="100" />
    ...
    <!-- 新增或修改窗口 -->
    <el-dialog :title="(form.id?'修改':'新增')+'图片'" :visible.sync="dialogVisible" width="36%" top="10vh">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="上传图片" prop="picurl">
          <el-tooltip class="item" effect="dark" content="请上传530x180的图片尺寸！" placement="right-start">
            <el-upload class="pic-upload size200x68" action="http://cloud.scnew.com.cn/api/user/upload" :before-upload="handleBeforeUpload" :on-success="handlePicSuccess" :show-file-list="false">
  ...
  computed: {
    searchData () {
      return this.tableData.filter(item => {
        ...
        const cd2 = this.keyword !== '' ? searchCd(this.keyword, item.title) : true
        return cd1 && cd2
      })
    }
  },
